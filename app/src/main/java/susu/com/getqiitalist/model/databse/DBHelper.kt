...
class DBHelper(val context: Context) : SQLiteOpenHelper(
     ...
     * データ追加
     */
    fun insertTODO(qiitaDTO: QiitaDTO) {
        val db = writableDatabase
        val values = ContentValues()
        try {
            values.put(DBConstruct.DataEntry.TITLE, qiitaDTO.title)
    ...
    fun selectTODO() : Array<String> {
        ...
        try {
            var cursor = db.query(
                ...
                arrayOf(DBConstruct.DataEntry.TITLE),
                null,
                null,
                null,
                null,
    ...
    companion object {
        ...
        private const val SQL_CREATE_TODO =
            "CREATE TABLE " + DBConstruct.DataEntry.TABLE_NAME + " (" +
                    ...
                    DBConstruct.DataEntry.TITLE + " TEXT)"
        /**
         * idのMAXから最大値を取得
         */
